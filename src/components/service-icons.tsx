...
function BrandIcon({
  ...
  slug,
  ...props
}: SVGProps<SVGSVGElement> & { path: string; slug: string }) {
  return (
    <svg
...
export function CodexIcon(props: SVGProps<SVGSVGElement>) {
  return <BrandIcon path={OPENAI_ICON_PATH} slug="openai" {...props} />;
}

export function NetflixIcon(props: SVGProps<SVGSVGElement>) {
  return <BrandIcon path={siNetflix.path} slug="netflix" {...props} />;
}
